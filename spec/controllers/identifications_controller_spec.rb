...
RSpec.describe IdentificationsController, type: :controller do
  ...
  # IdentificationsController. Be sure to keep this updated too.
  let(:valid_session) { {} }

  describe "GET #index" do
    it "assigns all identifications as @identifications" do
  ...
  describe "GET #show" do
    it "assigns the requested identification as @identification" do
      identification = Identification.create! valid_attributes
      get :show, params: {id: identification.to_param}, session: valid_session
      expect(assigns(:identification)).to eq(identification)
    end
  end

  describe "GET #new" do
    it "assigns a new identification as @identification" do
  ...
  describe "GET #edit" do
    it "assigns the requested identification as @identification" do
      identification = Identification.create! valid_attributes
      get :edit, params: {id: identification.to_param}, session: valid_session
      expect(assigns(:identification)).to eq(identification)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Identification" do
        expect {
          post :create, params: {identification: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved identification as @identification" do
        post :create, params: {identification: invalid_attributes}, session: valid_session
        expect(assigns(:identification)).to be_a_new(Identification)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested identification" do
        identification = Identification.create! valid_attributes
        put :update, params: {id: identification.to_param, identification: new_attributes}, session: valid_session
      ...
      it "assigns the requested identification as @identification" do
        identification = Identification.create! valid_attributes
        put :update, params: {id: identification.to_param, identification: valid_attributes}, session: valid_session
        expect(assigns(:identification)).to eq(identification)
      end
      ...
      it "redirects to the identification" do
        identification = Identification.create! valid_attributes
        put :update, params: {id: identification.to_param, identification: valid_attributes}, session: valid_session
        expect(response).to redirect_to(identification)
      end
    end

    context "with invalid params" do
      it "assigns the identification as @identification" do
        identification = Identification.create! valid_attributes
        put :update, params: {id: identification.to_param, identification: invalid_attributes}, session: valid_session
        expect(assigns(:identification)).to eq(identification)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested identification" do
      identification = Identification.create! valid_attributes
      expect {
        delete :destroy, params: {id: identification.to_param}, session: valid_session
      }.to change(Identification, :count).by(-1)
    end
