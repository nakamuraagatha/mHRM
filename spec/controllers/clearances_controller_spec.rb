...
RSpec.describe ClearancesController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all clearances as @clearances" do
  ...
  describe "GET #show" do
    it "assigns the requested clearance as @clearance" do
      clearance = Clearance.create! valid_attributes
  ...
  describe "GET #new" do
    it "assigns a new clearance as @clearance" do
  ...
  describe "GET #edit" do
    it "assigns the requested clearance as @clearance" do
      clearance = Clearance.create! valid_attributes
      get :edit, params: {id: clearance.to_param}, session: valid_session
      expect(assigns(:clearance)).to eq(clearance)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created clearance as @clearance" do
        post :create, params: {clearance: valid_attributes}, session: valid_session
      ...
      it "redirects to the created clearance" do
        post :create, params: {clearance: valid_attributes}, session: valid_session
        expect(response).to redirect_to(Clearance.last)
      end
    end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "redirects to the clearance" do
        clearance = Clearance.create! valid_attributes
        put :update, params: {id: clearance.to_param, clearance: valid_attributes}, session: valid_session
        expect(response).to redirect_to(clearance)
      end
    end
  ...
  describe "DELETE #destroy" do
    ...
    it "redirects to the clearances list" do
      clearance = Clearance.create! valid_attributes
      delete :destroy, params: {id: clearance.to_param}, session: valid_session
      expect(response).to redirect_to(clearances_url)
    end
  end
