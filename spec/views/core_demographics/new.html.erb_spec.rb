...
RSpec.describe "core_demographics/new", type: :view do
  before(:each) do
    assign(:core_demographic, CoreDemographic.new(
      :first_name => "MyString",
      :last_name => "MyString",
  ...
  it "renders new core_demographic form" do
    render

    assert_select "form[action=?][method=?]", core_demographics_path, "post" do
